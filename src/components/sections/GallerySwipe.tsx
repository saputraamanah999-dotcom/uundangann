...
function MarqueeRow({ photos, direction, onSelect }: {
  photos: Photo[];
  ...
  return (
    <section id="section-gallery" className="relative py-20 bg-gradient-to-b from-[#0d0309] via-[#1a0b16] to-[#0d0309] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-1 w-full max-w-lg mx-auto">
        <MarqueeRow photos={row1} direction="left" onSelect={handleSelect} />
        <MarqueeRow photos={row2} direction="right" onSelect={handleSelect} />
        <MarqueeRow photos={row3} direction="left" onSelect={handleSelect} />
        <MarqueeRow photos={row4} direction="right" onSelect={handleSelect} />
      </div>
