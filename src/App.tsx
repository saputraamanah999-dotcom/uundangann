...
export default function App() {
  ...
  const coupleNames = `${config.couple.groom.nickname} & ${config.couple.bride.nickname}`;
              ...
              <div className="relative h-72 w-full overflow-hidden">
                ...
                <div className="absolute inset-x-0 bottom-6 text-center">
                  ...
                  <h2 className="font-serif text-2xl font-bold text-amber-200 tracking-wide drop-shadow-md">
                    Pawiwahan Suci {coupleNames}
                  </h2>
                </div>
              </div>

              {/* Live Concurrent Visitors badge row */}
              <div className="py-4 text-center bg-gradient-to-b from-[#0d0309] to-[#1b0814]">
                <LiveVisitorBadge />
              </div>
